...
exports.main = async (event, context) => {
  ...
  await db.collection('wordsInfo')
    ...
    .end().then(res => {
      ...
      let SHUFFLEPAGEALLCOUNT = Math.ceil(new_wordsList.length / 3);
      console.log(SHUFFLEPAGEALLCOUNT);
      resultData = {
        SHUFFLEPAGEALLCOUNT: SHUFFLEPAGEALLCOUNT,
        choosedusrTipsShuffle: new_wordsList,
        usrTipsShuffle: new_wordsList.slice(0, 3)
      }
